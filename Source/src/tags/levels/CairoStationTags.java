...
public class CairoStationTags extends TagGroup {
    ...
    public CairoStationTags(RestorationPreferences prefs) {
        ...
        tagMods = new TagMod[] {
                ...
                // Ambience
                new TagMod("/sound_remastered/ambience/spacestation/spacestation_bigroom/spacestation_bigroom.sound_looping", -1), // Gain +1 from default
                new TagMod("/sound_remastered/ambience/spacestation/spacestation_smallroom/spacestation_smallroom.sound_looping", -7), // Gain +1 from default
                ...
                new TagMod( // (moody ambience before door breach)
                        ...
                        prefs.getMusicGain() + -11 // Gain -8 from default
                ),
